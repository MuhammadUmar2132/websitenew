              ...
              <motion.div variants={itemVariants}>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 pr-11 bg-gray-700/50 rounded-lg border ${errors.password ? 'border-rose-500' : 'border-gray-600/50'} focus:ring-2 focus:ring-indigo-500 text-gray-100 placeholder-gray-400 backdrop-blur-sm`}
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
